...
class Environment:
    ...
    def reset(self):
        ...
        #                self.simulator.add_forcing_to(rod).using(SigmoidActivationLongitudinalMuscles, start_time = 3-80*0.01, end_time = 3, start_idx = 0, end_idx=170, beta=1, tau=0.01, activation_level_max=0.5, activation_level_end=0.00)
        #            if idx == 1 or idx == 2 or idx == 8:
        #                self.simulator.add_forcing_to(rod).using(
        #                     ActivationRampUpRampDown,
        #                     ramp_up_time=1.5,
