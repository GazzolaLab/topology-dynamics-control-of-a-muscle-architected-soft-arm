    ...
    def reset(self):
        ...
        for idx, rod in enumerate(self.straight_rod_list):
            ...
            if idx == 4 or idx == 5 or idx == 6:
                ...
                #                )
                #                self.simulator.add_forcing_to(rod).using(SigmoidActivationLongitudinalMuscles, start_time = 1, end_time = 15, start_idx = 0, end_idx=170, beta=1, tau=0.02, activation_level_max=0.3, activation_level_end=0.3)
                self.simulator.add_forcing_to(rod).using(
                    SigmoidActivationLongitudinalMuscles,
                    start_time=1,
                    end_time=6,
        ...
        #        for idx, rod in enumerate(self.helical_rod_list[:4]):
        #            self.simulator.add_forcing_to(rod).using(
        #                    LocalActivation, ramp_interval = 0.5, ramp_up_time=6.1, ramp_down_time = 14.0, start_idx = 0, end_idx = 150, activation_level=0.20,
        #                )
        #
