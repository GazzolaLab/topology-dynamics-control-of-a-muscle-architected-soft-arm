    ...
    def reset(self):
        ...
        for idx, rod in enumerate(self.straight_rod_list):
            ...
            if idx == 1 or idx == 2 or idx == 8:
                ...
                #                self.simulator.add_forcing_to(rod).using(
                #                    LocalActivation, ramp_interval = 1.0, ramp_up_time=0.0, ramp_down_time = 3.0, start_idx = 0, end_idx = 80, activation_level=0.8,
                #                )
                self.simulator.add_forcing_to(rod).using(
                    SigmoidActivationLongitudinalMuscles,
                    start_time=3 - 80 * 0.01,
                    end_time=3,
                    start_idx=0,
                    end_idx=170,
                    beta=1,
                    tau=0.01,
                    activation_level_max=0.8,
        ...
        for idx, rod in enumerate(self.helical_rod_list[:4]):
            ...
            self.simulator.add_forcing_to(rod).using(
                SigmoidActivationLongitudinalMuscles,
                start_time=3 - 160 * 0.005,
                end_time=3,
                start_idx=0,
                end_idx=359 - 18,
                beta=1,
                tau=0.005,
                activation_level_max=0.30,
